    ...
    return (
      <WrapperTag
        className={classNames([
          'flex items-center gap-2 px-4 bg-white ring-1 text-primary-500 hover:ring-primary-700 focus-within:caret-primary-700 active:caret-primary-700 active:ring-primary-700 active:ring-2 focus-within:ring-primary-700 focus-within:ring-2 ease-in-out duration-200',
          {
            'ring-2 ring-negative-700': invalid,
            'ring-1 ring-primary-300': !invalid,
      ...
      >
        ...
        <input
          className={classNames([
            'min-w-[80px] w-full text-base !outline-none appearance-none text-primary-900 disabled:cursor-not-allowed disabled:bg-transparent read-only:bg-transparent',
            className,
          ])}
          type="text"
